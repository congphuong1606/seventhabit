...
@TargetApi(Build.VERSION_CODES.CUPCAKE) public class SwipeLayout extends FrameLayout {
    @Deprecated
    ...
    @TargetApi(Build.VERSION_CODES.CUPCAKE) private boolean performAdapterViewItemLongClick() {
    ...
    @TargetApi(Build.VERSION_CODES.CUPCAKE) private boolean isTouchOnSurface(MotionEvent ev) {
        View surfaceView = getSurfaceView();
        if (surfaceView == null) {
            return false;
        }
